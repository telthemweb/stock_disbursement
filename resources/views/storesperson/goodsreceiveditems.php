                    ...
                    <div id="switchPoint" class="e-panel card">
                        <div class="card-body">
                            <div class="card-title">
                                <h6 class="mr-2"><span>Goods Ready For Transfer</span><small class="px-1"></small></h6>
                            </div>
                                        ...
                                        <?php foreach ($goodreceiveds as $prod): $i++; ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="text-success"  href="<?php route('/store/transfer/'.$prod->id) ?>" >
                                                        <button class="btn btn-success float-right rounded-0">
                                                            Tranfer to CIDP <i class="fa fa-share"></i>
                                                        </button>
                                                    </a>
                                                </td>
                                            </tr>
