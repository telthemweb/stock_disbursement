                    ...
                    <div id="switchPoint" class="e-panel card">
                        <div class="card-body">
                            <div class="card-title">
                                <h6 class="mr-2"><span>Goods Received</span><small class="px-1"></small></h6>
                            </div>
                                        ...
                                        <?php foreach ($goodreceiveds as $prod): $i++; ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="text-success"  href="<?php route('/inputs/accept/'.$prod->id) ?>" >
                                                        <button class="btn btn-success float-right rounded-0">
                                                            Receive <i class="fa fa-check-circle"></i>
                                                        </button>
                                                    </a>
                                                </td>
                                            </tr>
